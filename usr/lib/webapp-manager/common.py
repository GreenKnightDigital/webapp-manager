...
class WebAppManager():
    ...
    def get_supported_browsers(self):
        ...
        browsers.append(Browser(BROWSER_TYPE_CHROMIUM, "Brave (Flatpak)", "/var/lib/flatpak/exports/bin/org.brave.Browser", "/var/lib/flatpak/exports/bin/com.brave.Browser"))
